    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_death', models.DateTimeField(blank=True, help_text='Введите дату смерти', null=True, verbose_name='Дата смерти')),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('summary', models.TextField(help_text='Введите описание текста', max_length=1000, verbose_name='Описание текста')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(help_text='Изменить состояние книги', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.status', verbose_name='Статус экземпляра книги')),
            ],
        ),
        migrations.AddField(
            model_name='book',
